...
#电机参数来自于Unitree官方提供的Gazebo模型，经过转换得到。Gazebo模型中的电机参数可能不完全准确，因此在实际使用中可能需要进行调整以获得更好的性能。
...
G1_CYLINDER_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(#初始姿态
        pos=(0.0, 0.0, 0.76),
        joint_pos={#初始站立关节位置
...
#根据电机的力矩限制和刚度计算出动作缩放因子，确保在仿真中施加的动作不会超过电机的能力范围，从而提高仿真的稳定性和真实性。
G1_ACTION_SCALE = {}
